...
<!-- services block -->
  <div class="bg-light-gray p-5">
      ...
      <div class="row">
        <div class="col-lg-4 service-column">
          ...
          <div class="services">
            ...
            <p class="text-muted">Free Shipping around Kampala</p>
          </div>  
        </div>
        <div class="col-lg-4 service-column">
          <div class="service-icon">
          ...
          <div class="services">
            <h6 class="text-uppercase">Quality Guaranteed</h6>
            <p class="text-muted">Our products are very high quality</p>
          </div>  
        </div>
        <div class="col-lg-4 service-column">
          <div class="service-icon">
          ...
          <div class="services">
            <h6 class="text-uppercase">+256756287319</h6>
	...
	<!-- main block, menus and subscribe form -->

	<div class="bg-gray py-5 text-muted">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-2 my-5 col-md-6">
            	...
            	<div class="col-lg-4 my-5">
              		<h6 class="text-uppercase text-dark mb-3">Exceptional Quality</h6>
              		<p class="mb-3"> To be cheated, Let us serve you with the best quality there's!</p>
              			<!-- <form action="#" id="newsletter-form">
                			<div class="input-group mb-3">
                 			 <input type="email" placeholder="Your Email Address" aria-label="Your Email Address" class="form-control bg-transparent border-secondary border-right-0 rounded-0">
                  			<div class="input-group-append">
                    <button type="submit" class="btn btn-outline-secondary border-left-0 rounded-0"> <i class="fa fa-paper-plane text-lg text-dark"></i></button>
                  </div>
                </div>
              </form> -->
            </div>
		...
		<div class="container">
			<div class="row">
				<div class="text-white text-center">
					<p class="mb-md-0" style="letter-spacing: 3px;">&copy; 2022 AUTOXUG. All rights reserved.</p>
				</div>
			</div>
		</div>
	</div>
